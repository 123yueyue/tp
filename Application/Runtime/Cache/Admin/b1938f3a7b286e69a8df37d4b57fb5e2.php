...
$(function(){
	...
	$('.del').on('click',function(){
		...
		//带着参数跳转到del方法
		window.location.href = '/tp/index.php/Admin/Teacher/del/id/' + id;
	});
});
...
$(function(){
	...
	$('.add').on('click',function(){
		window.location.href = '/tp/index.php/Admin/Teacher/add';
	});
});
</script>
</html>